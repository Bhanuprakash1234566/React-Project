...
function Cart() {
  ...
  const confirmPayment = () => {
   ...
   emailjs.send(
      'service_gvkzwc9',    // Replace with your actual Service ID
      'template_k5zcqmb',   // Replace with your actual Template ID
      templateParams,
      'An_dB65yNIt0S-INN'   // Replace with your Public Key
    )
     .then(
      (response) => {
        ...
        <>
          ...
          {paymentMethod === 'UPI' && (
            <div className="qr-popup">
              ...
              <QRCode
                value={`upi://pay?pa=8919040174@ibl&pn=BhanuStore&am=${finalPrice.toFixed(2)}&cu=INR`}
              />
